...
parser = argparse.ArgumentParser(description="Calculates anything you want "
                                             "about your credit payments")
...
if (int(args.payment is None) + int(args.periods is None) + int(args.principal is None)
        + int(args.type is None)) >= 2 or args.interest is None:
